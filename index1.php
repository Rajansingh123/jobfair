...
<div class="banner">
	...
	<form action="search.php" method="GET">
			<input type="text" name="query" class="text" placeholder=" " value="Enter Keyword(s)" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Keyword(s)';}">
	 ...
	 <div class="single1">  
	   <div class="col-md-4">
	   	  <div class="col_3">
	   	  	<h3>Calender</h3>
	   	  	<iframe src="https://calendar.google.com/calendar/b/1/embed?title=Event%20Calander&amp;height=600&amp;wkst=1&amp;bgcolor=%239999ff&amp;src=1odhhlfjl5a7ov24v7g76g9a9o%40group.calendar.google.com&amp;color=%23691426&amp;ctz=America%2FToronto" style="border:solid 1px #777" width="430" height="300" frameborder="0" scrolling="no"></iframe>
	   	  </div>
			</div>
	 </div>
